...
export const SERVICES: Service[] = [
...

  {
    ...
    description: 'Técnica que valoriza o formato natural do rosto, respeitando simetria e proporções.',
    fullDescription: 'Realça a expressão e harmoniza o olhar de forma sutil e personalizada.',
    duration: '1h 30min',
    maintenance: '15 a 20 dias',
    image: 'DesignSobrancelhas.jpeg',
    priceEstimate: 'R$ 50,00'
  }
];
